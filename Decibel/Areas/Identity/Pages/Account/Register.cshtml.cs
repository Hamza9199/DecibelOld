...
namespace Decibel.Areas.Identity.Pages.Account
{
        public class RegisterModel : PageModel
        {
                ...
                public async Task<IActionResult> OnPostAsync(string returnUrl = null)
                {
                        if (ModelState.IsValid)
                        {
                                ...
                                var result = await _autentifikacijaServis.RegisterUserAsync(user, Input.Password, Input.KorisnickoIme, Input.Ime, Input.Prezime, returnUrl);
